...
Route::post('/delete-product/{id}', 'HomeController@deleteproduct')->name('deleteproduct')->middleware('check');
...
Route::post('/delete-user/{id}', 'HomeController@deleteuser')->name('deleteuser')->middleware('check');
